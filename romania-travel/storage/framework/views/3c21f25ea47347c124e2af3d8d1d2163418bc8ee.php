                      ...
                      <div class="card-body">
                        <div class="row">
                          ...
                          <div class="col-sm-9 text-secondary">
                            <input name="name" value="<?php echo e(\Illuminate\Support\Facades\Auth::user()->name); ?>" class="" type="text" style="width: 250px">
                          </div>
                        </div>
                        <hr>
                        <div class="row">
                          ...
                          <div class="col-sm-9 text-secondary">
                            ...
                            <input name="email" value="<?php echo e(\Illuminate\Support\Facades\Auth::user()->email); ?>" <?php $__errorArgs = ['email'];
...
unset($__errorArgs, $__bag); ?>" name="email" class="" type="text" style="width: 250px">
                        ...
                        <div class="row">
                          <div class="col-sm-12">
                            <a href="editare-cont"><button class="button button-md button-default-outline-2 button-ujarak">Actualizare Informatii</button></a>
                          </div>
                        </div>
                      </div>
                    </form>
...
<?php /**PATH D:\xampp\htdocs\romania-travel\resources\views/editare-cont.blade.php ENDPATH**/ ?>