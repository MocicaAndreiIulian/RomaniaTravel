...
<div class="btn-group" role="group" aria-label="Basic example">
                  <a href=<?php echo e("destroy-resetpass/".$resetpass->userId); ?>><button type="submit" style="margin-right: 5px" class="btn btn-danger">Șterge</button></a>
                  <a href=<?php echo e("user-schimba-".$resetpass->userId); ?>><button style="margin-right: 5px" type="submit" class="btn btn-info">Schimbă Parola</button></a>
</div>
                </td>
                  </tr>
...
<?php /**PATH D:\xampp\htdocs\romania-travel\resources\views/view-resetpasses.blade.php ENDPATH**/ ?>