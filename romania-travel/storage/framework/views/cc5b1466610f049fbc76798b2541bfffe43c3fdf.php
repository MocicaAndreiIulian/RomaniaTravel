                   ...
                   <div class="btn-group" role="group" aria-label="Basic example">
                                        ...
                                        <?php if($location->approve == 0): ?>
                                          <a href=<?php echo e("approve-post-".$location->id); ?>>
                                            <button style="margin-right: 5px;" type="submit" name="approve" class="btn btn-primary">Aproba</button></a>
                                            <?php elseif($location->approve == 1): ?>
                                              <a href=<?php echo e("disapprove-post-".$location->id); ?>>
                                                <button style="margin-right: 5px;" type="submit" name="disapprove" class="btn btn-primary">Dezaproba</button></a>
                                          <?php endif; ?>
                                          <a href=<?php echo e("continut-postare-".$location->id); ?>><button type="submit" class="btn btn-info">Vezi Postarea</button></a>

                                             <a href=<?php echo e("destroy-post/".$location->id); ?>><button style="margin-left: 5px" type="submit" class="btn btn-danger">Șterge</button></a></td>
                   </div>
                                   </td>
...
<?php /**PATH C:\xampp\htdocs\romania-travel2\romania-travel\resources\views/view-posts.blade.php ENDPATH**/ ?>