...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/js/bootstrap.min.js" integrity="sha384-QJHtvGhmr9XOIpI6YVutG+2QOK9T+ZnN4kzFN1RtK3zEFEIsxhlmWl5/YESvpZ13" crossorigin="anonymous"></script>
  ...
  <body>
    ...
    <tbody>
      ...
      <tr>
        <th scope="row"><?php echo e($myPost->id); ?></th>
        <td>      <?php echo e(date("d-m-Y H:i:s", strtotime($myPost->created_at))); ?></td>
          <td><?php echo e($myPost->title); ?></td>
        <td>    <?php switch($myPost->approve):
                                        case (1): ?>
                                            Aprobat
                                          <?php break; ?>
                                          <?php case (0): ?>
        ...
        <div class="btn-group" role="group" aria-label="Basic example">
                               ...
                               <a href="<?php echo e("continut-postare-".$myPost->id); ?>"><button style="margin-right: 5px" type="submit" class="btn btn-info">Detalii</button></a>
                             </td>
...
<?php /**PATH C:\xampp\htdocs\romania-travel\resources\views/postarile-mele.blade.php ENDPATH**/ ?>