  ...
  <body>
    ...
    <?php echo $__env->make('layouts.user-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
          ...
          <div class="swiper-slide context-dark" data-slide-bg="images/banner/banner3.jpg">
            ...
            <div class="swiper-slide-caption section-md">
              <div class="container">
                <div class="row">
                  <div class="col-md-10">
                    <h6 class="text-uppercase" data-caption-animate="fadeInRight" data-caption-delay="0">Postari</h6>
                    <h2 class="oh font-weight-light" data-caption-animate="slideInUp" data-caption-delay="100"><span>Vezi experientele altor utilizatori</span><span class="font-weight-bold"> din diverse locatii!</span></h2><a class="button button-default-outline button-ujarak" href="recenzii-locatii" data-caption-animate="fadeInLeft" data-caption-delay="0">Vezi Postari</a>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="swiper-slide context-dark" data-slide-bg="images/banner/banner1.jpg">
            ...
            <div class="swiper-slide-caption section-md">
              <div class="container">
                <div class="row">
                  <div class="col-md-10">
                    <h6 class="text-uppercase" data-caption-animate="fadeInRight" data-caption-delay="0">Intrebari si Raspunsuri</h6>
                    <h2 class="oh font-weight-light" data-caption-animate="slideInUp" data-caption-delay="100"><span>Ai nelamuriri despre o locatie? Ne poti adresa oricand o </span><span class="font-weight-bold">intrebare!</span></h2><a class="button button-default-outline button-ujarak" href="intrebari" data-caption-animate="fadeInLeft" data-caption-delay="0">Adauga Intrebare</a>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="box-width-lg-470">
                ...
                <div class="tabs-custom tabs-horizontal tabs-line tabs-line-big tabs-line-style-2 text-center text-md-left" id="tabs-7">
                  ...
                  <ul class="nav nav-tabs">
                    ...
                    <li class="nav-item" role="presentation"><a class="nav-link" href="#tabs-7-2" data-toggle="tab">Care este misiunea noastra.</a></li>
                  </ul>
                  <!-- Tab panes-->
                  <div class="tab-content">
                    <div class="tab-pane fade show active" id="tabs-7-1">
                      <p>Platforma Web "Romania-Travel" a fost conceputa din dorinta de a promova turismul romanesc, ce are atat de mult potential. Cu ajutorul platformei utilizatorii pot vedea articole ce au legatura directa cu turismul, postarile altor utilizatori din diverse locatii si pot adresa diverse intrebari, desigur, tot din domeniul turistic.</p>
                    </div>
                    <div class="tab-pane fade" id="tabs-7-2">
                      <p>Ne dorim sa cream o comunitate cat mai unita unde toate persoanele ce au pasiunea calatoritului sa redescopere pasiunea calatoritolui in Romania. Misiunea noastra este promovarea turismului romanesc prin prezentarea locatiilor inedite atat prin intermediul articolelor cat si prin intermediul postarilor trimise de catre utilizatori.</p>
                    </div>
      ...
      <section class="section section-sm">
        <div class="container">
          <h3>De ce sa accesezi platforma noastra?</h3>
              ...
              <article class="box-icon-classic">
                <div class="unit box-icon-classic-body flex-column flex-md-row text-md-left flex-lg-column text-lg-center flex-xl-row text-xl-left">
                  ...
                  <div class="unit-body">
                    ...
                    <p class="box-icon-classic-text">Este bine sa fii informat, aici gasesti articole din diverse domenii pentru o calatorie excelenta.</p><br>
                  </div>
                </div>
              </article>
            </div>
            <div class="col-sm-6 col-lg-4">
              <article class="box-icon-classic">
                <div class="unit box-icon-classic-body flex-column flex-md-row text-md-left flex-lg-column text-lg-center flex-xl-row text-xl-left">
                  ...
                  <div class="unit-body">
                    <h5 class="box-icon-classic-title"><a href="recenzii-locatii">Postari</a></h5>
                    <p class="box-icon-classic-text">Poti adauga o noua postare despre ultima locatie vizitata sau te poti inspira din postarile altor utilizatori.</p><br>
                  </div>
                </div>
              </article>
            </div>
            <div class="col-sm-6 col-lg-4">
              <article class="box-icon-classic">
                <div class="unit box-icon-classic-body flex-column flex-md-row text-md-left flex-lg-column text-lg-center flex-xl-row text-xl-left">
                  ...
                  <div class="unit-body">
                    <h5 class="box-icon-classic-title"><a href="intrebari">Intrebari</a></h5>
                    <p class="box-icon-classic-text">Ai nelamuriri in ceea ce priveste o locatie? Poti adresa o intrebare comunitatii, cu siguranta vei fi ajutat. </p>
                  </div>
                </div>
              </article>
            </div>
      ...
      <section class="section section-sm bg-default">
        <div class="container">
          <h3 class="oh-desktop"><span class="d-inline-block wow slideInDown">Ultimele Postari Adaugate</span></h3>
      ...
      <div class="container">
<br>
        <h3 class="title-block find-car oh"><span class="d-inline-block wow slideInUp">Statistici de privit pe plaja</span></h3>
        <br>
      </div>
              ...
              <div class="row row-50 justify-content-center border-classic">
                ...
                <div class="col-sm-6 col-md-5 col-lg-2">
                  <div class="counter-classic">
                    ...
                    <h5 class="counter-classic-title">Postari</h5>
                  </div>
                </div>
                <div class="col-sm-6 col-md-5 col-lg-2">
                  <div class="counter-classic">
                ...
                <div class="col-sm-6 col-md-5 col-lg-2">
                  <div class="counter-classic">
                    ...
                    <h5 class="counter-classic-title">Intrebari</h5>
                  </div>
                </div>
                <div class="col-sm-6 col-md-5 col-lg-2">
                  <div class="counter-classic">
                    ...
                    <h5 class="counter-classic-title">Raspunsuri</h5>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section class="section bg-default text-center offset-top-50">
        <div class="parallax-container" data-parallax-img="images/index/booking4.jpg">
          <div class="parallax-content section-xl section-inset-custom-1 context-dark bg-overlay-2-21">
            <div class="container">
              <h2 class="heading-2 oh font-weight-normal wow slideInDown"><span class="d-block font-weight-semi-bold">Alege cazarea perfecta</span><span class="d-block font-weight-light">pentru tine</span></h2>
              <p class="text-width-medium text-spacing-75 wow fadeInLeft" data-wow-delay=".1s">Alege din mii de unitati de cazare disponibile pe Booking</p><a class="button button-secondary button-pipaluk" href="https://www.booking.com/" target="_blank">Rezerva Acum!</a>
            </div>
          </div>
        </div>
      </section>
...
<?php /**PATH C:\xampp\htdocs\romania-travel2\romania-travel\resources\views/welcome.blade.php ENDPATH**/ ?>