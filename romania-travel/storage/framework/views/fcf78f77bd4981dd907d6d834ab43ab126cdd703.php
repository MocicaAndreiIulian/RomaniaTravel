...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/js/bootstrap.min.js" integrity="sha384-QJHtvGhmr9XOIpI6YVutG+2QOK9T+ZnN4kzFN1RtK3zEFEIsxhlmWl5/YESvpZ13" crossorigin="anonymous"></script>
  ...
  <body>
    ...
    <tbody>
      <?php $__currentLoopData = $myArticles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $myArticle): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <tr>
        <th scope="row"><?php echo e($myArticle->id); ?></th>
        <td>      <?php echo e(date("d-m-Y H:i:s", strtotime($myArticle->created_at))); ?></td>
          <td><?php echo e($myArticle->title); ?></td>
                <td><?php echo e($myArticle->joinNameCategory); ?></td>
        <td>    <?php switch($myArticle->status):
                                        case (1): ?>
                                            Aprobat
                                          <?php break; ?>
                                          <?php case (0): ?>
        ...
        <div class="btn-group" role="group" aria-label="Basic example">
                               ...
                               <a href="<?php echo e("continut-articol-".$myArticle->id); ?>"><button style="margin-right: 5px" type="submit" class="btn btn-info">Detalii</button></a>
                             </td>
...
<?php /**PATH C:\xampp\htdocs\romania-travel2\romania-travel\resources\views/articolele-mele.blade.php ENDPATH**/ ?>