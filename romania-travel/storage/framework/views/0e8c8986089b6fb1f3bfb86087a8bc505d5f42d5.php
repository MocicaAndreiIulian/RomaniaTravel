              ...
              <div class="col-lg-9">
                      ...
                      <div class="col-md-6">
                          <ul class="list-inline shop-top-menu pb-3 pt-1">
                              <li class="list-inline-item">
                                  <a class="h4 text-dark text-decoration-none mr-3" href="#"><?php echo e($articles[0]->categoryName); ?></a>
                              </li>
                ...
                <?php $__currentLoopData = $articles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $article): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      ...
                      <?php else: ?> 
                          <ul class="list-inline shop-top-menu pb-3 pt-1">
                              <li class="list-inline-item">
                                  <a class="h4 text-dark text-decoration-none mr-3" href="#">Nu exista articole din aceasta categorie</a>
                              </li>
...
<?php /**PATH D:\xampp\htdocs\romania-travel\resources\views/articole-categorie.blade.php ENDPATH**/ ?>