        ...
        <div class="container">
          ...
          <form method="post" action="sendMessage">
            ...
            <div class="row row-14 gutters-14">
              <div class="col-md-4">
                <div class="form-wrap">
                  <input class="form-input" id="contact-your-name-2" type="text" name="name" value="<?php echo e(\Illuminate\Support\Facades\Auth::user()->name); ?>"data-constraints="@Required">
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-wrap">
                  <input class="form-input" id="contact-email-2" type="email" name="email"  value ="<?php echo e(\Illuminate\Support\Facades\Auth::user()->email); ?>" data-constraints="@Email  @Required">
                </div>
              </div>
              <?php else: ?>
              <div class="row row-14 gutters-14">
                ...
                <div class="col-md-4">
                  <div class="form-wrap">
                    <input class="form-input" id="contact-email-2" type="email" name="email" data-constraints="@Email  ">
...
<?php /**PATH D:\xampp\htdocs\romania-travel\resources\views/contact.blade.php ENDPATH**/ ?>