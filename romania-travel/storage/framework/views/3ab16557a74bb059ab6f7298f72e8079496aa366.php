...
<html class="wide wow-animation" lang="en">
  ...
  <body>
    ...
    <?php echo $__env->make('layouts.user-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        ...
        <div class="container">
          <div class="d-flex justify-content-between">
              <div>
                  ...
                  <?php else: ?>
                  <button class="btn btn-primary" type="button" data-toggle="modal" data-target="#newQuestion" title="Trebuie sa fii conectat pentru a adăuga o întrebare" disabled>Adaugă Întrebare</button>
              ...
              <div>
                <form action="cauta-intrebare" method="POST">
                  ...
                  <div class="input-group">
                      <input class="form-control" name="questions" type="text" placeholder="Caută o întrebare..." aria-label="Caută un articol..." aria-describedby="button-search" />
      ...
      <div class="card-body">
        ...
        <div class="d-flex justify-content-between">
            <div>
               <h6>Număr răspunsuri primite:</h6>
               <br>
  ...
  <?php if(auth()->guard()->check()): ?>
            ...
            <div class="form-wrap">
              ...
              <input class="form-input" id="contact-your-name-2" type="text" name="title" data-constraints="@Required" required="">
            </div>
            <div class="form-wrap">
                <p style="margin-top: 10px"><b>Conţinut întrebare:</b></p>
                <div class="form-wrap">
                  <textarea class="form-input textarea-lg" id="contact-message-2" name="question" data-constraints="@Required" required=""></textarea>
                </div>
              </div>
...
<?php /**PATH D:\xampp\htdocs\romania-travel\resources\views/cauta-intrebare.blade.php ENDPATH**/ ?>