          ...
          <div class="d-flex justify-content-between">
              <div>
                  <?php if(auth()->guard()->check()): ?>
                        <a href="adauga-postare"><button class="btn btn-primary" type="submit">Adaugă o nouă postare</button></a>
                  <?php else: ?>
                  <button class="btn btn-primary" type="button" title="Trebuie sa fii conectat pentru a adăuga o postare" disabled>Adaugă o nouă postare</button>
...
<?php /**PATH D:\xampp\htdocs\romania-travel\resources\views/cauta-postare.blade.php ENDPATH**/ ?>