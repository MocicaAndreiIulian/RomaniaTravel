...
#map-canvas {
  ...
  <body>
    ...
    <div style="min-height:350px">
  			<div id="latlong">
  				<input id="pac-input" class="controls" name="locations" type="text" placeholder="Cauta locatia">
...
<?php /**PATH C:\xampp\htdocs\romania-travel\resources\views/adauga-postare.blade.php ENDPATH**/ ?>