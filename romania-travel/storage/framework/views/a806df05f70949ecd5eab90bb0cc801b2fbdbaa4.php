          ...
          <div class="d-flex justify-content-between">
              <div>
                  <?php if(auth()->guard()->check()): ?>
                        <a href="adauga-postare"><button class="btn btn-primary" type="submit">Adauga o noua postare</button></a>
                  <?php else: ?>
                  <button class="btn btn-primary" type="button" title="Trebuie sa fii conectat pentru a adauga o postare" disabled>Adauga o noua postare</button>
              ...
              <div>
                <form action="cauta-postare" method="POST">
                  ...
                  <div class="input-group">
                      <input class="form-control" name="locations" type="text" placeholder="Cauta o postare..." aria-label="Cauta un articol..." aria-describedby="button-search" />
...
<?php /**PATH C:\xampp\htdocs\romania-travel2\romania-travel\resources\views/recenzii-locatii.blade.php ENDPATH**/ ?>