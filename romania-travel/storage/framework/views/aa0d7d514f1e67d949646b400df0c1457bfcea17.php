                             ...
                             <div class="card bg-light">
                                 <div class="card-body">
                                     ...
                                     <form action="addComment" method="POST">
                                         <?php echo csrf_field(); ?>
                                       <textarea class="form-control" name="comment" rows="3" placeholder="Asteptam cu nerabdare parerea ta despre acest articol!" required=""  oninvalid="this.setCustomValidity('Camp necompletat!')" oninput="setCustomValidity('')"></textarea>
...
<div class="float-right">
    ...
    <?php else: ?>
    Trebuie să fii conectat pentru a putea adauga un comentariu
                                  <?php endif; ?>
                                     <br><br><br>
...
<?php echo e($comment -> comment); ?>                                           <!-- Child comment 1-->
        ...
        <button type="submit" style="margin-bottom : 10px" class="btn btn-success btn-lg"><i class="fa fa-edit" aria-hidden="true"></i> Editeaza Articol</button></a>
<?php endif; ?>
                         <!-- Search widget-->
                         <div class="card mb-4">
...
<?php else: ?>
 ...
 <?php endif; ?>
<?php /**PATH C:\xampp\htdocs\romania-travel\resources\views/continut-articol.blade.php ENDPATH**/ ?>