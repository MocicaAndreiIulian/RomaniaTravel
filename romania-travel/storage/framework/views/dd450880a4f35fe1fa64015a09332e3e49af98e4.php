          ...
          <form method="post" action="updateUserArticle" enctype="multipart/form-data">
            ...
            <div class="row row-14 gutters-14">
              ...
              <div class="col-md-12">
                <div class="form-wrap">
                  ...
                  <select class="form-control" name="categoryId">
                    <option value="<?php echo e($articles[0]->joinIdCategory); ?>">Categoria actuală: <?php echo e($articles[0]->joinNameCategory); ?></option>
              ...
              <div class="form-wrap">
                ...
                <textarea class="form-input textarea-lg" id="contact-message-2" name="description" required="" oninvalid="this.setCustomValidity('Cȃmp necompletat (minim 10 caractere)!')" oninput="setCustomValidity('')" minlength="10" maxlength="300"><?php echo e($articles[0]->description); ?></textarea>
              </div>
            </div>
              <div class="col-md-12">
                ...
                <input class="form-input" id="imgInp" type="file" name="image"  >
                    ...
                    <input type="hidden" value="<?php echo e($articles[0]->image); ?>" name="imageText" required=""  oninvalid="this.setCustomValidity('Selectaţi o imagine!')" oninput="setCustomValidity('')">
              ...
              <div class="col-12">
                <h5>Conținut articol:</h5>
                  <textarea class="ckeditor" id="content" name="content"  required=""   oninvalid="this.setCustomValidity('Camp necompletat!')" oninput="setCustomValidity('')">  <?php echo e($articles[0]->content); ?></textarea>

              </div>
            </div>
            <br>
            <button class="btn btn-primary" type="submit">Editează Articolul</button>
          </form>
        </div>
      </section>
...
<?php /**PATH C:\xampp\htdocs\romania-travel\resources\views/edit-articleuser.blade.php ENDPATH**/ ?>