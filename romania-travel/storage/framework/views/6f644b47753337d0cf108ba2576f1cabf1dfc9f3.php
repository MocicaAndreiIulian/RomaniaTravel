      ...
      <div class="row row-30 justify-content-center">
          <article class="title-classic">
            ...
            <div class="title-classic-text">
              <p>Daca ati uitat parola completati formularul de mai jos</p>
            </div>
            </div>
            </div>
      <!-- Contact information-->
            ...
            <div class="row row-14 gutters-14">
              ...
              <div class="col-md-6">
                <div class="form-wrap">
                  ...
                  <label class="form-label" for="contact-email-2">E-mail(cel folosit pentru creearea contului)</label>
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-wrap">
...
<?php /**PATH C:\xampp\htdocs\romania-travel2\romania-travel\resources\views/resetpass.blade.php ENDPATH**/ ?>