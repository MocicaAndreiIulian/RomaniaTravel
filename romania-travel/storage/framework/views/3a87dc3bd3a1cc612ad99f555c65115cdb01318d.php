                 ...
                 <div class="row">
                         ...
                         <article>
                             ...
                             <section class="mb-5">
                               ...
                               <div style="min-height:350px">
                                   <div id="latlong">
                                     <input id="pac-input" class="controls" value="<?php echo e($location->location); ?>"  name="locations" type="hidden" placeholder="Caută locaţia">
                     ...
                     <div class="col-lg-4">
                             ...
                             <div class="card-body">
                                 <div class="row">
                                            ...
                                            <p style="text-align: center"><b>Scopul deplasării: <?php echo e($locations[0]-> purpose); ?></b></p>
                                             <p style="text-align: center"><b>Utilizatorul recomandă locaţia: <?php echo e($locations[0]-> recommend); ?></b></p>
                        ...
                        <div class="d-flex justify-content-center">
                         ...
                         <p><b>Reacţii Pozitive: <?php echo e($statistics['usefulReactions']); ?></b></p>
                         <p><b>Reacţii Negative: <?php echo e($statistics['uselessReactions']); ?></b></p>
                         <br><br>
                         <!-- Side widget-->
                     </div>
                 </div>
...
<?php else: ?>
 ...
 <?php endif; ?>
<?php /**PATH D:\xampp\htdocs\romania-travel\resources\views/continut-postare.blade.php ENDPATH**/ ?>