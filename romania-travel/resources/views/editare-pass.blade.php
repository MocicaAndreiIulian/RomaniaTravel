                      ...
                      <div class="card-body">
                        <div class="row">
                          ...
                          <div class="col-sm-9 text-secondary">
                            <input name="name" value="{{\Illuminate\Support\Facades\Auth::user()->name}}" class="" type="text" readonly style="width: 250px">
                          </div>
                        </div>
                        <hr>
                        <div class="row">
                          ...
                          <div class="col-sm-9 text-secondary">
                            <input name="email" value="{{\Illuminate\Support\Facades\Auth::user()->email}}" class="" type="text" readonly style="width: 250px">
                        ...
                        <div class="row">
                          ...
                          <div class="col-sm-9 text-secondary">
                            <input name="password" placeholder="Introduceţi noua parolă" class="" type="password" style="width: 250px" minlength="8" oninvalid="this.setCustomValidity('Parola trebuie sa aibă minim 8 caractere!')" oninput="setCustomValidity('')">
