...
<html class="wide wow-animation" lang="en">
  ...
  <body>
              ...
              <div class="col-lg-9">
                      ...
                      <div class="col-md-6">
                          <ul class="list-inline shop-top-menu pb-3 pt-1">
                              <li class="list-inline-item">
                                  <a class="h4 text-dark text-decoration-none mr-3" href="#">{{$articles[0]->categoryName}}</a>
                              </li>
                ...
                @foreach($articles as $article)
                      ...
                      @else 
                          <ul class="list-inline shop-top-menu pb-3 pt-1">
                              <li class="list-inline-item">
                                  <a class="h4 text-dark text-decoration-none mr-3" href="#">Nu există articole din această categorie</a>
                              </li>
    ...
    <!-- Javascript-->
    <script>
   var msg = '{{Session::get('articolAdaugat')}}';
   var exist = '{{Session::has('articolAdaugat')}}';
   if(exist){
     alert(msg);
   }
 </script>
