           ...
           <div class="container-fluid">
               <div class="row">
                   ...
                   <div class="btn-group" role="group" aria-label="Basic example">
                    ...
                    @if($article->status == 0)
                    <a href={{"approve-article-".$article->id}}>
                      <button style="margin-right: 5px;" type="submit" name="approve" class="btn btn-primary">Aprobă</button></a>
                      @elseif($article->status == 1)
                        <a href={{"disapprove-article-".$article->id}}>
                          <button style="margin-right: 5px;" type="submit" name="disapprove" class="btn btn-primary">Dezaprobă</button></a>
                    @endif



                                          <a href={{"edit-article-".$article->id}}><button style="margin-right: 5px" type="submit" class="btn btn-primary">Editează</button></a>

                                             <a href={{"article-destroy/".$article->id}}><button type="submit" class="btn btn-danger">Șterge</button></a></td>
                   </div>
                                   </td>
...
<!-- final modal -->
<script>
   var msg = '{{Session::get('eroareBD')}}';
   var exist = '{{Session::has('eroareBD')}}';
   if(exist){
     alert(msg);
   }
 </script>
