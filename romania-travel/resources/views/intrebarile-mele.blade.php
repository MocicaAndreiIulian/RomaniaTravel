  ...
  <body>
      ...
      <br><br>
                    ...
                    <div class="card mt-3">
                      <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                          <h6 class="mb-0">Răspunsuri la întrebari:</h6>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>      {{  date("d-m-Y H:i:s", strtotime($myQuestion->created_at)) }}</td>
          <td>{{$myQuestion->title}}</td>
        <td>    @switch($myQuestion->approve)
                                        @case(1)
                                            Aprobat
                                          @break
                                          @case(0)
        ...
        <div class="btn-group" role="group" aria-label="Basic example">
                               ...
                               <a href="{{"vizualizare-intrebare-".$myQuestion->id}}"><button style="margin-right: 5px" type="submit" class="btn btn-info">Detalii</button></a>
                             </td>
