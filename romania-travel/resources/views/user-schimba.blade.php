                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <!-- form start -->
                                ...
                                <form id="quickForm" method="post" action="user-schimba">
                                    @csrf
                                    <div class="card-body">
                                        <div class="form-group">
                                            <label>ID</label>
                                            <input name="id" value="{{$users[0] -> id}}"  required="" type="text" class="form-control" readonly>
                                        </div>
                                        <div class="form-group">
                                            <label>Nume:</label>

                                            <input name="name"  value="{{$users[0] -> name}}" required="" type="text" class="form-control" readonly>

                                        </div>
                                        <div class="form-group">
                                            <label>Email:</label>

                                            <input name="email"  value="{{$users[0] -> email}}" required="" type="text" class="form-control" readonly>
                                            </div>
