  ...
  <body>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>      {{  date("d-m-Y H:i:s", strtotime($myPost->created_at)) }}</td>
          <td>{{$myPost->title}}</td>
        <td>    @switch($myPost->approve)
                                        @case(1)
                                            Aprobat
                                          @break
                                          @case(0)
        ...
        <div class="btn-group" role="group" aria-label="Basic example">
                               ...
                               <a href="{{"continut-postare-".$myPost->id}}"><button style="margin-right: 5px" type="submit" class="btn btn-info">Detalii</button></a>
                             </td>
