              ...
              <div class="row justify-content-center">
                ...
                <div class="col-md-4 wow fadeInDown col-9" data-wow-delay=".2s">
                  <ul class="list-marked-2 box-categories-list">
                    <li><a href="continut-articol-{{$article->id}}"><img src="{{'Images/Article/'.$article->image}}" alt="" width="368" height="420"/></a>
                      <h5 class="box-categories-title"><a href="continut-articol-{{$article->id}}">{{$article->title}}</a></h5>
                    </li>
                  </ul>
                </div>
                @endforeach
...
<br>
              ...
              <div class="row row-50 justify-content-center border-classic">
                <div class="col-sm-6 col-md-5 col-lg-2">
                  <div class="counter-classic">
                    <div class="counter-classic-number"><span class="counter">{{$statistics['users']}}</span>
                    </div>
                ...
                <div class="col-sm-6 col-md-5 col-lg-2">
                  <div class="counter-classic">
                    <div class="counter-classic-number"><span class="counter">{{$statistics['locations']}}</span>
                    </div>
                ...
                <div class="col-sm-6 col-md-5 col-lg-2">
                  <div class="counter-classic">
                              <div class="counter-classic-number"><span class="counter">{{$statistics['articles']}}</span>
                    </div>
                ...
                <div class="col-sm-6 col-md-5 col-lg-2">
                  <div class="counter-classic">
                    <div class="counter-classic-number"><span class="counter">{{$statistics['questions']}}</span>
                    </div>
                ...
                <div class="col-sm-6 col-md-5 col-lg-2">
                  <div class="counter-classic">
                    <div class="counter-classic-number"><span class="counter">{{$statistics['answers']}}</span>
                    </div>
          ...
          <div class="row row-30 justify-content-center box-ordered">
            ...
            <div class="col-sm-6 col-md-5 col-lg-3">
              ...
              <article class="team-modern">
                ...
                <div class="team-modern-header"><a class="team-modern-figure" href="{{'vizualizare-utilizator-'.$user['id']}}"><img class="img-circles" src="{{'Images/User/'.$user['picture']}}" alt="" width="118" height="118"/></a>
                  <svg x="0px" y="0px" width="270px" height="70px" viewbox="0 0 270 70" enable-background="new 0 0 270 70" xml:space="preserve">
                    <g>
                      <path fill="#161616" d="M202.085,0C193.477,28.912,166.708,50,135,50S76.523,28.912,67.915,0H0v70h270V0H202.085z"></path>
                          ...
                          @else
                          <div class="team-modern-header"><a class="team-modern-figure" href="{{'vizualizare-utilizator-'.$user['id']}}"><img class="img-circles" src="images/User/profil.png" alt="" width="118" height="118"/></a>
                            <svg x="0px" y="0px" width="270px" height="70px" viewbox="0 0 270 70" enable-background="new 0 0 270 70" xml:space="preserve">
                              <g>
                                <path fill="#161616" d="M202.085,0C193.477,28.912,166.708,50,135,50S76.523,28.912,67.915,0H0v70h270V0H202.085z"></path>
                              </g>
                ...
                <div class="team-modern-caption">
                  <h6 class="team-modern-name"><a href="{{'vizualizare-utilizator-'.$user['id']}}">{{$user['name']}}</a></h6>
                    <p class="team-modern-status">Scor: <b>{{$user['scores']}}</b> puncte</p>
                </div>
              </article>
            </div>
            @endforeach
    ...
    <!-- Javascript-->
    <script>
   var msg = '{{Session::get('mesajAdaugat')}}';
   var exist = '{{Session::has('mesajAdaugat')}}';
   if(exist){
     alert(msg);
   }
  </script>
  <script>
 var msg = '{{Session::get('eroare')}}';
 var exist = '{{Session::has('eroare')}}';
 if(exist){
   alert(msg);
 }
</script>
